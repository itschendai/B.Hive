...
This repo is the `B.Hive` adaptation of the same robotics platform for the Stanford
`ME310` Spring 2026 class project.
...
The `.gitignore` intentionally excludes regenerable and large artifacts so the repo
stays small:
